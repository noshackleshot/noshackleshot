<div style="display: flex; justify-content: center; align-items: center; width: 435px; height: 50px; background-color: rgba(0, 0, 0, 0); font-family: 'Roboto', sans-serif; font-weight: 700; font-size: 20px; color: #36BCF7FF; text-align: center;">
